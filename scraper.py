#!/usr/bin/env python3
"""
UniLodge Auckland — Daily Room Availability Report
Covers 4 North Island properties: Mayoral Drive, Auckland City, Wellesley, Auckland Central
...
PROPERTIES = {
    "Mayoral Drive": {
        "slug": "mayoral-drive",
        "subdomain": "www.wakefield.reserve.unilodge.com.au",
        "address": "Wakefield Street, Auckland CBD, New Zealand",
        "phone": "",
        "url": "https://www.unilodge.com.au/student-accommodation-auckland/mayoral-drive",
        "contracts": {
            "AUT 20-30 Weeks": {"stay_id": "2048", "from": "2026-07-01", "to": "2027-01-31"},
        },
    },
    "Auckland City": {
        "slug": "auckland-city",
        "subdomain": "www.whitaker.reserve.unilodge.com.au",
        "address": "Whitaker Place, Auckland CBD, New Zealand",
        "phone": "",
        "url": "https://www.unilodge.com.au/student-accommodation-auckland/auckland-city",
        "contracts": {
            "Full Year 52+ Weeks": {"stay_id": "2038", "from": "2026-07-15", "to": "2027-07-15"},
            "Semester Stay 20+ Weeks": {"stay_id": "2042", "from": "2026-07-15", "to": "2027-01-31"},
        },
    },
    "Wellesley Apartments": {
        "slug": "wellesley",
        "subdomain": "www.wellesley.reserve.unilodge.com.au",
        "address": "Wellesley Street, Auckland CBD, New Zealand",
        "phone": "",
        "url": "https://www.unilodge.com.au/student-accommodation-auckland/wellesley",
        "contracts": {
            "20-44 Week Stay": {"stay_id": "1666", "from": "2026-07-01", "to": "2027-05-01"},
            "45-52 Week Stay": {"stay_id": "1620", "from": "2026-07-01", "to": "2027-06-30"},
        },
    },
    "Auckland Central": {
        "slug": "auckland-central",
        "subdomain": "www.unilodgeaucklandcentral.reserve.unilodge.com.au",
        "address": "Auckland CBD, New Zealand",
        "phone": "",
        "url": "https://www.unilodge.com.au/student-accommodation-auckland/auckland-central",
        "contracts": {
            "Full Year - Semester 2": {"stay_id": "2061", "from": "2026-07-01", "to": "2027-06-30"},
            "Semester Stay - Semester 2": {"stay_id": "2060", "from": "2026-07-01", "to": "2027-01-31"},
        },
    },
}
...
def parse_availability_counts(html):
    ...
    badge_idx = 0
    for i, (room_pos, room_id) in enumerate(room_positions):
        next_room_pos = room_positions[i + 1][0] if i + 1 < len(room_positions) else len(html)
...
<title>UniLodge Auckland — 空房日报</title>
...
<style>
    ...
    *, *::before, *::after {{ box-sizing: border-box; margin: 0; padding: 0; }}
    ...
    .header h1 .dot {{ width: 10px; height: 10px; border-radius: 50%; background: #00529B; flex-shrink: 0; }}
...
<div class="header fade-in" style="animation-delay:0ms">
    <div class="header-top">
        <h1><span class="dot"></span>UniLodge Auckland 空房日报</h1>
    </div>
    <p class="meta">📍 Auckland, North Island, New Zealand — {prop_count} 所公寓 &ensp;|&ensp; 更新于 {update_time_display} &ensp;|&ensp; 🎯 起租: {CHECKIN_DATE} &ensp;|&ensp; 周一至周五 10:00 / 15:00 自动刷新</p>
</div>
...
<div class="footer fade-in" style="animation-delay:300ms">
    <div class="footer-grid">
        <div class="footer-card">
            <h3>房源概况</h3>
            <ul>
                <li>{prop_count} 所 UniLodge Auckland 公寓</li>
                <li>共 {total_types} 种房型 (首个合同)</li>
        ...
        <div class="footer-card">
            ...
            <ul>
                ...
                <li>macOS launchd 周一至周五自动抓取</li>
                <li>生成时间: {update_time_iso}</li>
            </ul>
        </div>
    </div>
    <p style="color:var(--text-muted);font-size:0.74rem;margin-top:20px;text-align:center">UniLodge Auckland · North Island · 仅供内部参考 · {update_time_display}</p>
</div>
...
def main():
    print("=" * 60)
    print("UniLodge Auckland — Daily Room Report Generator")
